...
Pronounced **co-JAY-son** – your happy path to JSON from Kotlin.

KoJSON provides:

- A tiny, opinionated `Json` facade that gives you strict & lenient accessors (`boolean` vs `booleanValue`, `int` vs `intValue`, etc).
